import { CognitiveStyle, FeedbackRequest } from '../../../shared/types';

export function buildFeedbackPrompt(request: FeedbackRequest): { systemPrompt: string; userPrompt: string } {
