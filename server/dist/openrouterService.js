...
async function generateCorrectiveFeedback(params) {
    const { profileCode, pedagogicLevel, visualPreference, processingOrientation, behavioralTempo, questionText, correctAnswer, studentAnswer, attemptNumber, } = params;
...
async function generateExplanation(params) {
    const { profileCode, pedagogicLevel, visualPreference, processingOrientation, behavioralTempo, questionText, correctAnswer, attemptNumber, } = params;
    const systemPrompt = `You are an adaptive learning tutor for computational thinking.
