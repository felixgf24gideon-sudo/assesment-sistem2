...
export const questions: Question[] = [
  ...
  {
    id: "q13",
    text: "In Git, what command is used to save changes to the local repository?",
  ...
  },
  {
    ...
    options: [
      ...
      "Improve rendering performance by minimizing actual DOM updates",
  ...
  },
  {
    ...
    options: [
      ...
      "Describing algorithm efficiency and complexity",
  ...
  {
    id: "q20",
    text: "In computer science, what is recursion?",
    options: [
